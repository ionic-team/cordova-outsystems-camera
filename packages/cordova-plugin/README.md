...
| **`editable`**           | <code>'in-app' \| 'no'</code>                         | Whether to allow the user to edit the photo after capture. - 'in-app': Enable in-app editing (plugin's built-in editor) - 'no': Disable editing (default) | <code>'no'</code>              | 1.0.0 |
...
| **`editable`**               | <code>'in-app' \| 'no'</code>            | Whether to allow the user to edit selected media. - 'in-app': Enable in-app editing (platform's built-in editor) - 'no': Disable editing (default)                                                                                                                                                                | <code>'no'</code>          | 1.0.0 |
